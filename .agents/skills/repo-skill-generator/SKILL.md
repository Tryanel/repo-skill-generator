...
description: Inspect a code repository and create repo-specific Codex, Claude, OpenCode, or Agent Skills-compatible instructions that distill focused capabilities into portable knowledge packs and optional same-language callable functions.
---

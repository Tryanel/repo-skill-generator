...
description: Inspect a code repository and create repo-specific Codex, Claude, or OpenCode skills from its observed development conventions. Use when OpenCode needs to read README files, docs, manifests, source code, tests, and configuration, then draft a platform-specific skill for future agents.
metadata:

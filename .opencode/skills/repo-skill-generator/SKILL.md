...
description: Inspect a code repository and create repo-specific Codex, Claude, or OpenCode skills that distill focused capabilities into portable knowledge packs and optional standalone scripts.
metadata:
